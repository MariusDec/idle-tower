...
This project is indexed by GitNexus as **idle-tower** (5110 symbols, 18962 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
